<?php
namespace DHBW\DhbwEvents\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class DHBW\DhbwEvents\Controller\EventController.
 *
...
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \DHBW\DhbwEvents\Controller\EventController
	 */
	protected $subject = NULL;

	public function setUp() {
		$this->subject = $this->getMock('DHBW\\DhbwEvents\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView() {
		...
		$eventRepository = $this->getMock('DHBW\\DhbwEvents\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenEventToView() {
		$event = new \DHBW\DhbwEvents\Domain\Model\Event();
